...
HWND g_hwnd_edit_request_count;        //поле редактирования кол-ва зявок
HWND g_hwnd_edit_work_count;         //поле редактирования кол-ва рабочих
HWND g_hwnd_button_start_pause;               //кнопка старт/пауза
HWND g_hwnd_button_stop;               //кнопка стоп
HWND g_hwnd_time_gen_sourse;  //вывод генерации времени заявок в источниках
HWND g_hwnd_count_gen_request;            //вывод кол-ва созданных заявок
HWND g_hwnd_sys_time;               //вывод модельного времени
HWND g_hwnd_redy_queue;               //вывод готовности очередей
HWND g_hwnd_count_request_queue;          //вывод кол-ва заявок в очереди
HWND g_hwnd_all_request_info;          //вывод кол-ва заявок каждого типа
HWND g_hwnd_channel_info;               //вывод состояния каналов
HWND g_hwnd_channel_time;      //вывод времени обработки заявок в каналах
HWND g_hwnd_count_request_collection;    //вывод кол-ва заявок в сборщике
